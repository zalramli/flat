    ...
    $(document).ready(function() {
      ...
      <div class="agile-grids"> 
        ...
        <div class="agile-tables">
          ...
          $query2 = mysql_query("SELECT SUM(pendapatan) AS total FROM pemasukan WHERE tgl_pemasukan BETWEEN '$awal_bulan2' AND '$akhir_bulan2'");
          $data2 = mysql_fetch_array($query2);
          $total = Rp." ".format_ribuan($data2['total']);
          ?>

          <strong><center>PENDAPATAN BULAN ke <?php echo $_POST['bulan'] ?> Tahun <?php echo $_POST['tahun'] ?>   adalah <?php echo "$total"; ?></center></strong>
          ...
          <tbody>
          <?php 
          $query = mysql_query("SELECT * FROM pemasukan where tgl_pemasukan BETWEEN '$awal_bulan' AND '$akhir_bulan'");
          ...
          ?>
            ...
            <tr>
            <td><?php echo TanggalIndo($data['tgl_pemasukan']); ?></td>
            <td><?php echo $data['perihal_pemasukan']; ?></td>
            <td><?php echo Rp." ". format_ribuan($data['pendapatan']); ?></td>
